...
-   Weekly logs & updates using a project manager (20%)
-   Github repository + code (15%)
-   Project
    -   Proposal (10%) (1-page)
    -   Exploratory Data Analysis (10%) (2-4 pages)
    -   Progress Report (10%) (3-5 pages)
    -   Final Report (20%) (5-7 pages)
    -   Presentation (10%) (length TBD)
-   Participation (5%)

#### Project Managers

You will be expected to use a project manager throughout the course and update it weekly. It should include both what you aim to accomplish over the next week and what you have accomplished in the previous week. Your tasks should be well-described.

It is up to you to choose what you want to use, but two examples are:
...
| Jan 15 | Project discussions + DS/ML topics |         | WL                                               |
| Jan 22 | EDA + Visualization                |         | WL                                               |
| Jan 29 | DS + ML topics                     |         | Proposal + WL                                    |
| Feb 5  | Github/coding/Reports              |         | WL                                               |
| Feb 12 | DS + ML topics                     |         | EDA + WL                                         |
| Feb 26 | Communication                      |         | WL                                               |
| Mar 5  | DS + ML topics                     |         | Progress Report + WL + GH repository (1)         |
| Mar 12 | Project structures                 |         | WL                                               |
| Mar 19 | DS + ML topics                     |         | WL                                               |
| Mar 26 | DS + ML topics                     |         | WL                                               |
| Apr 2  | Presentations                      |         | Final Report + Presentations + GH Repository (2) |
